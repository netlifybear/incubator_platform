...
- Auto contribution tags run through the tag computation engine on review submit, profile update, and cron.
...
- Credibility report verification polish: optional; keep separate from the impact dashboard.
...
- Do not execute streak or workflow changes without a focused UX plan.
