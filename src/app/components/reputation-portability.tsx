  ...
  return (
    <section className="rounded-[2rem] border border-[var(--border)] bg-[var(--panel)] p-8 shadow-sm">
      <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[var(--accent)]">
        Cross-incubator reputation
      </p>
      <h2 className="mt-4 text-3xl font-semibold tracking-tight">
        Portable reputation
      </h2>
      <p className="mt-4 max-w-2xl leading-7 text-[var(--muted)]">
        Export your reputation as a signed JWT to import into another incubator instance,
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-2">
        <div className="rounded-3xl border border-[var(--border)] bg-white/70 p-6">
          <h3 className="text-lg font-semibold">Export your reputation</h3>
          <p className="mt-2 text-sm leading-6 text-[var(--muted)]">
            Generate a signed packet containing your cohort status, badges, points, and
            review aggregates. Share this JWT with another incubator to import your reputation.
          </p>
          <button
            type="button"
          ...
          >
            {exporting ? "Generating..." : "Export reputation"}
          </button>
          {exportError && (
        ...
        <div className="rounded-3xl border border-[var(--border)] bg-white/70 p-6">
          <h3 className="text-lg font-semibold">Import reputation</h3>
          <p className="mt-2 text-sm leading-6 text-[var(--muted)]">
            Paste a JWT from another incubator instance or a previous cohort export
            to bring your reputation credentials here.
          </p>
          <textarea
            value={importJwt}
          ...
          >
            {importing ? "Verifying..." : "Import reputation"}
          </button>
          {importError && (
